...
const PropertyCard = ({data}) => {
  ...
  return (
    <div className='bg-white shadow-md rounded '>
      <img src={data?.cover ? `${import.meta.env.VITE_IMG_BASE_URL}/${data.cover}` : DefaultCover} alt={data?.title || "Property Image"} className='rounded cursor-pointer' onClick={()=>handlePropertyClick(data.id)}/>
