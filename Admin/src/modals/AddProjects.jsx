...
const AddProjects = ({setOpenAddProjectModal, fetchData}) => {
  ...
  let handleForm = async(e)=>{
    e.preventDefault();
    try {
      let response = await API.post(`http://localhost:5000/api/project/projects`,{name,location,status,description});
  ...
  return (
    <div className='fixed w-screen h-screen top-0 left-0 flex justify-center items-center bg-[#0000003a]' onClick={()=>setOpenAddProjectModal(false)}>
