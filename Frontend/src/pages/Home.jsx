          ...
          {projectsData.length > 0 ? (
            projectsData.map((project, index) => (
              <div className="flex flex-col gap-4" key={index}>
                <img src={project?.cover ? `${import.meta.env.VITE_IMG_BASE_URL}/${project.cover}` : DefaultCover} alt="img" className='grayscale hover:grayscale-0 cursor-pointer w-full h-[35vh] md:h-[25vh] lg:h-[65vh]' onClick={()=>navigate(`/projects/${project.id}`)}/>
