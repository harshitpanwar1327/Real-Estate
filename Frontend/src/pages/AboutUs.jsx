    ...
    <>
      ...
      <div className="px-6 md:px-16 py-16 bg-white flex flex-col gap-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <img src={VissionImg} alt="Real Estate Project" className="w-full rounded shadow-md"/>
        </div>
