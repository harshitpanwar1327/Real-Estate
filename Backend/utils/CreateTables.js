...
const projects = `CREATE TABLE IF NOT EXISTS projects(
    ...
    status ENUM('Ready for Possession', 'Under Construction', 'Upcoming') NOT NULL,
    description TEXT,
...
const properties = `CREATE TABLE IF NOT EXISTS properties(
    ...
    category ENUM('Residential', 'Commercial', 'Industrial', 'Agriculture') NOT NULL,
    property_type ENUM('Plot', 'Villa', 'High Rise Apartment', 'Low Rise Apartment', 'Shops', 'SEO', 'Built up', 'Land') NOT NULL,
    bedrooms INT,
    bathrooms INT,
    balcony INT,
    store INT,
